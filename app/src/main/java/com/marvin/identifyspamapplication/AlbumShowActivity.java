    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Return_page.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(AlbumShowActivity.this, MainActivity.class);
        ...
        switch (Show_Choice)
        {
            ...
            case TAKE_PHOTO:{
                ...
                if (Build.VERSION.SDK_INT < 24) {
                    ...
                    imageUri = FileProvider.getUriForFile(AlbumShowActivity.this, "com.MapScanner.MapScanner", outputImage);
                }
                // 启动相机程序
            ...
            {
                //如果没有权限则申请权限
                if (ContextCompat.checkSelfPermission(AlbumShowActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(AlbumShowActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
                }
                //调用打开相册
                openAlbum();
            }
